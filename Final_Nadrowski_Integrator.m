function [T,Y]=Final_Nadrowski_Integrator(Amp_Input,Freq_Input,delta_t,t_end)
...
[T,Y] = ode45(@Hair_Bundle_ODE45,[0:delta_t:t_end],[0 0 0 0],options,Amp_Input,Freq_Input);
...
dy(1)=(1/lambda)*(-K_gs*(y(1)-y(2)-D*PO(y(1),y(2),A,delta_Po_term))-K_sp*y(1)+Amp*sin(2*pi*freq*y(4))+X_Noise); 
dy(2) =(1/lambda_a)*(K_gs*(y(1)-y(2)-D*PO(y(1),y(2),A,delta_Po_term))+(gamma*f_max*  ((S*(y(3)/C_M))-1))+Xa_Noise);
